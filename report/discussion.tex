...
frequency is not clear, since the path through the normal parity bits
would be shorter as the update  while the path through the SECDED bit would be longer



This would, however, most
